...
This script rename all files in the specified directory to uppercase.
and then replace all hyphen (-) with whitespace.
"""
...
for f in file_list:
    ...
    new_f = os.path.join(working_directory, filename_split[0].replace("-", " ").upper() + filename_split[1])
